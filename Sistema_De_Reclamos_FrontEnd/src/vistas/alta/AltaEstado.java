...
public class AltaEstado extends JDialog {
...
/*	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AltaEstado dialog = new AltaEstado(null);
	 ...
	 * Create the frame.
	 */
	public AltaEstado(String referer) {
		...
		btnGuardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				try {
					String result = estadoController.altaEstado(nombre.getText(), descripcion.getText(), referer);
					if(result != ""){
						dispose();
